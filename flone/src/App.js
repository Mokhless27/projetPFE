...
import ProductsEspaceAdmin from "./pages/EspaceAdmin/ProductsEspaceAdmin";
import BlogFormAjout from "./pages/EspaceAdmin/BlogFormAjout";
import ProductFormAjout from "./pages/EspaceAdmin/ProductFormAjout";
import UsersAdmin from "./pages/EspaceAdmin/UsersAdmin";
import LivraisonAdmin from "./pages/EspaceAdmin/LivraisonAdmin";
import ProductFormModif from "./pages/EspaceAdmin/ProductFormModif";
import BlogFormModif from "./pages/EspaceAdmin/BlogFormModif";
import PropositionsAdmin from "./pages/EspaceAdmin/PropositionsAdmin";
        ...
        <BrowserRouter>
          <ScrollToTop>
            <Switch>
              ...
              <Route
                path={process.env.PUBLIC_URL + "/play/Quiz"}
                // exact
                component={Play}
              />
              <Route
                path={process.env.PUBLIC_URL + "/play/Home"}
                // exact
                component={Home}
              />

              <Route
                path={process.env.PUBLIC_URL + "/EspaceAdmin"}
                // exact
                component={EspaceAdmin}
              />

              <Route
                path={process.env.PUBLIC_URL + "/ProductsEspaceAdmin"}
                // exact
                component={ProductsEspaceAdmin}
              />
              <Route
                path={process.env.PUBLIC_URL + "/BlogFormAjout"}
                // exact
                component={BlogFormAjout}
              />
              <Route
                path={process.env.PUBLIC_URL + "/ProductFormAjout"}
                // exact
                component={ProductFormAjout}
              />

              <Route
                path={process.env.PUBLIC_URL + "/UsersAdmin"}
                // exact
                component={UsersAdmin}
              />

              <Route
                path={process.env.PUBLIC_URL + "/LivraisonAdmin"}
                // exact
                component={LivraisonAdmin}
              />

              <Route
                path={process.env.PUBLIC_URL + "/PropositionsAdmin"}
                // exact
                component={PropositionsAdmin}
              />
              ...
              <Route
                path={process.env.PUBLIC_URL + "/productFormModif/:id"}
                render={(routeProps) => (
                  <ProductFormModif
                    {...routeProps}
                    key={routeProps.match.params.id}
              ...
              <Route
                path={process.env.PUBLIC_URL + "/blogFormModif/:id"}
                render={(routeProps) => (
                  <BlogFormModif
                    {...routeProps}
                    key={routeProps.match.params.id}
