...
const BlogSidebar = ({ blogs, loading, getAllBlogs }) => {
  useEffect(() => {
    getAllBlogs();
  }, []);
  return (
                ...
                return (
                  <div className="single-sidebar-blog">
                    ...
                    <div className="sidebar-blog-content">
                      <span>{blog.time.slice(0, 10)}</span>
                      <h4>
                        <Link
                          to={
                            process.env.PUBLIC_URL +
...
export default connect(mapStateToProps, { getAllBlogs })(BlogSidebar);
